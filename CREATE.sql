...
CREATE TABLE dbo.Restaurant(
    ...
    monStartTime NUMERIC(4,0),
    monEndTime NUMERIC(4,0),
    tuesStartTime NUMERIC(4,0),
    tuesEndTime NUMERIC(4,0),
    wedStartTime NUMERIC(4,0),
    wedEndTime NUMERIC(4,0),
    thuStartTime NUMERIC(4,0),
    thuEndTime NUMERIC(4,0),
    friStartTime NUMERIC(4,0),
    friEndTime NUMERIC(4,0),
    satStartTime NUMERIC(4,0),
    satEndTime NUMERIC(4,0),
    sunStartTime NUMERIC(4,0),
    sunEndTime NUMERIC(4,0),
    stopId CHAR(5),
    walktimeToRes DECIMAL(11,10),
